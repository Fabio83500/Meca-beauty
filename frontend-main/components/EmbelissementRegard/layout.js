    ...
    return (
        <>
            <div id='quiSommesNous' className='my-20 grid md:grid-cols-2 gap-x-20 '>
                    <Image src={imgQuiSommesNous} alt="Qui sommes nous" className="h-96 object-cover rounded-2xl" />
            <div>
                    <h2 className='text-2xl text-center font-semibold text-[#ED069E] mb-4'>Embelissement du regard</h2>
                    <p className=' my-4'>
