...
import contactTel from "@/public/assets/images/contactTel.png"
...
export default function Home() {
    ...
    return (
        <>
            <Head>
                <title>Meca Beauty - Contact</title>
              ...
              <ul className="flex flex-col p-4 space-y-2">
                ...
                <div className='max-w-7xl mx-auto '>
                    <div className='flex flex-col items-center justify-center mt-20 space-y-6'>
                        <h2 className='text-5xl mb-4 text-[#4e4e4e] font-bold text-center'>Nos contacts</h2>
                        <span className='block md:text-3xl font-bold bg-gradient-to-r from-[#763EF7] text-center
                         to-[#EE8481] bg-clip-text text-transparent '>Vous souhaitez prendre rendez-vous ? contactez moi </span>

                    </div>

                    <div className='grid md:grid-cols-2 gap-20 mt-10'>
                        <Link href="https://www.instagram.com/meca___beauty/" className='bg-white flex flex-col items-center justify-center p-6 rounded-xl shadow space-y-4'>
                           
                            <span className='text-xl font-medium text-[#ED069E] block '>Envoie moi un message sur instagram</span>
                            ...
                            <span className='text-[#696868] block text-lg font-semibold'>Meca Beauty by Anaïs</span>
                        </Link>
                        
                       <Link href="tel:07 49 43 88 55" className='bg-white flex flex-col items-center justify-center p-6 rounded-xl shadow space-y-4'>
                            <span className='text-xl font-medium text-[#ED069E] block '>Contact moi par téléphone</span>
                              <Image src={contactTel} className='w-40' />
                            <span className='text-[#696868] block text-lg font-semibold'>07 49 43 88 55</span>
                        </Link>
                    </div>
                        ...
                        id="" href="/#realisations"
                         ...
                         font-medium text-white hover:bg-pink-600 bg-[#ED069E] transition
                          duration-150 ease-in-out">
                           <span id="" className="block text-xl">Voir plus de réalisations</span>
                        </a>
                    </div>
